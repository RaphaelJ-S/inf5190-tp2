...
# J'ai fais des changements à la classe testée qui la rendent très
# difficile à tester.
# TODO voir comment je peux changer l'architecture pour faciliter les tests
...
#     mock_donnees = [
#         ["un", "deux", "nom1"], ["deux", "trois", "nom2"]]
#     prem_mock = MagicMock()
#     deux_mock = MagicMock()
#     anc_donnees = [prem_mock, deux_mock]
#     prem_mock.as_partial_list = mock_donnees[0]
#     deux_mock.as_partial_list = mock_donnees[1]
